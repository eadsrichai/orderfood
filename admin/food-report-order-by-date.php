<div>
<form action="index.php?42" method="GET">
            <input type="hidden" value="42" name="menu" />
            <input type="date" value="" name="mydate" placeholder="ค้นหาโดย วันเดือนปี " />
            <input type="submit" value="SearchByDate" name="submit" />
</form>

<?php 
if(isset($_GET['submit']) && ($_GET['submit'] == "SearchByDate")) {
        $date_order = $_GET['mydate'];
        echo $date_order;
        ...
        AND   order_food.date_order like '$date_order%'";
